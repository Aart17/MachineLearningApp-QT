from PyQt5.QtCore import Qt, pyqtSignal, QPoint, QDateTime, QTimer
...
class TitleBar(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.now_date_label = QLabel(self)
        self.timer2 = QTimer(self)
        self.timer2.timeout.connect(self.show_clock)
        self.timer2.start(1000)
        layout.addWidget(self.titleLabel)
        layout.addWidget(self.now_date_label)
        ...
        font2 = self.font() or QFont()
        font2.setFamily('Wingdings')
    ...
    def show_clock(self):
        ...
        self.now_date_label.setText(text)
    ...
    def setTitle(self, title):
        ...
        self.titleLabel.setStyleSheet("* {font: bold italic;}")
...
class FramelessWindow(QWidget):
    ...
    def setWidget(self, widget):
        ...
        palette.setColor(palette.Window, QColor(256, 0, 0))
        self._widget.setPalette(palette)
        self._widget.installEventFilter(self)
        self.layout().addWidget(self._widget)

    def move(self, pos, filter=None):
        if filter is None:
            ...
            x = pos[0]
            y = pos[1]
            super(FramelessWindow, self).move(x, y)
